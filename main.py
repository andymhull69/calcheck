...
def update_session():
    ...
    for idx, row in enumerate(records):
        if (row.get("Email Address", "").strip().lower() == email.strip().lower() and
            ...
            break
    return '''<html><head><meta http-equiv="refresh" content="2;url=/client-admin" /></head><body><h3 style="color: green;">✅ Changes saved! Returning to Client Admin...</h3></body></html>'''
